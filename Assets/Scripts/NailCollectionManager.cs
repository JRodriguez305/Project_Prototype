...
public class NailCollectionManager : MonoBehaviour
{
    public static NailCollectionManager Instance;
    ...
    private void AllNailsCollected()
    {
        ...
        {
            Debug.LogWarning("⚠️ Reward object is not assigned in NailCollectionManager!");
        }
    }
}
